...
class MarketplaceCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\Marketplace::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/marketplace');
        CRUD::setEntityNameStrings('marketplace', 'marketplaces');
    }
